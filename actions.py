...
def add_credential(connection, username, password, tag):
    ...
    connection.sendall((b'3-' + username.encode('utf-8') +
                        b'-' + password.encode('utf-8') +
                        b'-' + tag.encode('utf-8') +
                        b'-' + service_name.encode('utf-8') +
                        b'-' + service_password.encode('utf-8')))
    result = int(connection.recv(1).decode('utf-8'))
    connection.recv(2)  # remove \r\n
    if result == 1:
...
def delete_credential(connection, username, password, tag):
    ...
    connection.sendall((b'4-' + username.encode('utf-8') +
                        b'-' + password.encode('utf-8') +
                        b'-' + tag.encode('utf-8') +
                        b'-' + service_name.encode('utf-8')))
    result = int(connection.recv(1).decode('utf-8'))
...
def view_credential(connection, username, password, tag):
    ...
    connection.sendall((b'5-' + username.encode('utf-8') +
                        b'-' + password.encode('utf-8') +
                        b'-' + tag.encode('utf-8') +
                        b'-' + service_name.encode('utf-8')))
    result = int(connection.recv(1).decode('utf-8'))
